...
class TranscriptionService:
    ...
    def generateTranscriptions(self):
        ...
        for counter in range(0, totalTranscriptionSteps):
            ...
            transcript = self.generateTranscriptionsViaSubprocess(self.configuration.getSubprocessCommandString(), self.testData.getOriginalSentence(counter)) #only for development
    ...
    def generateTranscriptionsViaSubprocess(self, commandString, audioFilePath):
        return audioFilePath.replace("\'", "") #Only for Development
